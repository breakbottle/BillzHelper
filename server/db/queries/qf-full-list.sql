                ...
                Select * from (
                    ...
                    Union all
                        Select 'CURRENT PERIOD','',null,(select StartDate from bill_creditors where id=1),false,0
                    Union all
                    Select 'TOTAL','',(select sum(amt_due) FROM billmgr bm
                     ...
                     DATE_ADD( (select StartDate from bill_creditors where id=1) , INTERVAL 29 DAY ),false,0
                    Union all
                        Select
                            'TOTAL',
                            'DUE NOW!!',
                            ...
                            DATE_ADD( (select StartDate from bill_creditors where id=1) , INTERVAL 14 DAY ),false,0
                    Union all
                        Select
                            'TOTAL',
                            'DUE NEXT?',
                            ...
                            where
                                ...
                                DATE_ADD( (select StartDate from bill_creditors where id=1) , INTERVAL 28 DAY ),false,0
                ) fullListandCalac
                order by due_date